...
public struct Configuration {
    ...
    func css(isLight: Bool, alignment: TextAlignment) -> String {
        ...
        h1, h2, h3, h4, h5, h6, p, div, dl, ol, ul, pre, blockquote {text-align:\(alignment.htmlDescription); line-height: \(lineHeight)px; font-family: '\(fontType.name)' !important; color: \(fontColor.value(isLight)); }
